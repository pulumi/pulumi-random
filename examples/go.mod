...
require (
	...
	github.com/pulumi/pulumi-terraform-bridge/v3 v3.50.1 // indirect
	...
	github.com/terraform-providers/terraform-provider-random v1.3.2-0.20230412201459-2affb0e900a2 // indirect
