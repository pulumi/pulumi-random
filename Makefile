PROJECT_NAME := Random Package
include build/common.mk

PACK             := random
PACKDIR          := sdk
PROJECT          := github.com/pulumi/pulumi-random
NODE_MODULE_NAME := @pulumi/random
...
install_plugins:
	...
	pulumi plugin install resource aws 0.16.7
	pulumi plugin install resource azure 0.16.7
