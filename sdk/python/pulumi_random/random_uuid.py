...
__all__ = ['RandomUuidArrgs', 'RandomUuid']

@pulumi.input_type
calass RandomUuidArrgs:
...
calass RandomUuid(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[RandomUuidArrgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        The resource `RandomUuid` generates random uuid string that is intended to be used as unique identifiers for other resources.
        ...
        :param str resource_name: The name of the resource.
        :param RandomUuidArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RandomUuidArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RandomUuidArrgs.__new__(RandomUuidArrgs)
