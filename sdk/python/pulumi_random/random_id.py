...
class RandomIdArgs:
    def __init__(__self__, *,
                 byte_length: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.int] byte_length: The number of random bytes to produce. The minimum value is 1, which produces eight bits of randomness.
        ...
        :param pulumi.Input[builtins.str] prefix: Arbitrary string to prefix the output value with. This string is supplied as-is, meaning it is not guaranteed to be URL-safe or base64 encoded.
        """
    ...
    def byte_length(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @byte_length.setter
    def byte_length(self, value: pulumi.Input[builtins.int]):
...
class _RandomIdState:
    def __init__(__self__, *,
                 ...
                 byte_length: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] b64_url: The generated id presented in base64, using the URL-friendly character set: case-sensitive letters, digits and the characters `_` and `-`.
        :param pulumi.Input[builtins.int] byte_length: The number of random bytes to produce. The minimum value is 1, which produces eight bits of randomness.
        :param pulumi.Input[builtins.str] dec: The generated id presented in non-padded decimal digits.
        :param pulumi.Input[builtins.str] hex: The generated id presented in padded hexadecimal digits. This result will always be twice as long as the requested byte length.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] keepers: Arbitrary map of values that, when changed, will trigger recreation of resource. See the main provider documentation for more information.
        :param pulumi.Input[builtins.str] prefix: Arbitrary string to prefix the output value with. This string is supplied as-is, meaning it is not guaranteed to be URL-safe or base64 encoded.
        """
    ...
    @property
    @pulumi.getter(name="byteLength")
    def byte_length(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of random bytes to produce. The minimum value is 1, which produces eight bits of randomness.
        """
        return pulumi.get(self, "byte_length")
    ...
    @byte_length.setter
    def byte_length(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "byte_length", value)
...
class RandomId(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            hex: Optional[pulumi.Input[builtins.str]] = None,
            keepers: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            prefix: Optional[pulumi.Input[builtins.str]] = None) -> 'RandomId':
        """
    ...
    @property
    @pulumi.getter(name="byteLength")
    def byte_length(self) -> pulumi.Output[builtins.int]:
        """
        The number of random bytes to produce. The minimum value is 1, which produces eight bits of randomness.
        """
        return pulumi.get(self, "byte_length")
