...
public class RandomShuffle extends com.pulumi.resources.CustomResource {
    ...
    /**
     * @return Random permutation of the list of strings given in `input`. The number of elements is determined by `resultCount` if set, or the number of elements in `input`.
     * 
     */
