...
public class RandomBytes extends com.pulumi.resources.CustomResource {
     ...
     */
    public RandomBytes(java.lang.String name, RandomBytesArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RandomBytes(java.lang.String name, RandomBytesArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("random:index/randomBytes:RandomBytes", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RandomBytes(java.lang.String name, Output<java.lang.String> id, @Nullable RandomBytesState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("random:index/randomBytes:RandomBytes", name, state, makeResourceOptions(options, id), false);
    }

    private static RandomBytesArgs makeArgs(RandomBytesArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RandomBytesArgs.Empty : args;
    }
     ...
     */
    public static RandomBytes get(java.lang.String name, Output<java.lang.String> id, @Nullable RandomBytesState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
